function popularpedidos(){
	...
	$.ajax({
		url: '/System/systemBasic/view/FazerPedido/pedido-saida.php', // Url do lado server que vai receber o arquivo
		dataType: 'json',
		type: 'post',
		data: {
			id: id,
	...
	$.ajax({
		...
		success: function(dados) {
			if (dados == "S") {
				...
				nroProdutosCarrinho($("#id_cf").text(), 'Cliente');
			}
		},
		error: function(dados) {
			$.bootstrapGrowl("ERRO!", {
...
$(document).ready(function() {
	...
	$("#finalizar").click(function(){
		...
		finalizar(id_cf, 'Cliente', vencimento, status);
	});
});
