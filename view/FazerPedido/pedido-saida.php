<?php
	...
	$query = $db->query("SELECT PR.ID AS ID, PR.NOME AS NOME, PR.VALOR AS VALOR, PR.DESCRICAO AS DESCRICAO, P.QUANTIDADE AS TEM FROM PEDINDO AS P INNER JOIN PRODUTO AS PR ON PR.ID = P.ID_PRODUTO WHERE P.ID_CLIENTE = " . $id);
